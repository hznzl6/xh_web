                ...
                <div class="login-form">
                    ...
                    <el-form ref="form" :model="LoginForm" label-width="80px">
                        <el-form-item label="账号:">
                            <el-input maxlength="9" placeholder="输入账号" v-model="LoginForm.account"></el-input>
                        </el-form-item>
    ...
    methods: {
        ...
        Login() {
            if(this.LoginForm.account == '') {
                ...
                // const url = process.env.VUE_APP_BASE_URI + '/houtai-account/account-login'
                const url = '/api/backstage-account/login'
                ...
                .then(res => {
                    ...
                    this.LoginToken = res
                    // console.log(res)
                    localStorage.setItem("HoutaiToken", res)
                    this.$message({
                        message: '登陆成功',
                        type: 'success'
                    })
                    localStorage.setItem("isHoutai", "true")
                    this.$router.push("/houtai/"+this.LoginForm.account)
                })
            }
