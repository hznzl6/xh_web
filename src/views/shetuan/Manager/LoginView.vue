<template>
    <div class="houtai-LoginContainer" v-loading.fullscreen.lock="fullscreenLoading">
                ...
                <div class="login-form">
                    ...
                    <el-form ref="form" :model="LoginForm" label-width="80px">
                        ...
                        <el-form-item label="密码:">
                            <el-input type="password" maxlength="13" placeholder="输入密码" v-model="LoginForm.pwd"></el-input>
                        </el-form-item>
                        ...
                        <div style="display: flex;justify-content: flex-end;">
                            <!-- <el-button @click="guest" type="text">游客登陆</el-button> -->
...
export default {
    ...
    methods: {
        ...
        guest() {
            this.LoginForm.account = 'test',
            this.LoginForm.pwd = '123456',
            this.LoginForm.yan = this.verifyCode
        },
        Login() {
            if(this.LoginForm.account == '') {
                ...
                const url = '/api/manager-account/login'
                this.fullscreenLoading = true
                axios.post(`${url}?account=${data.account}&pwd=${data.pwd}`, {}, {
                    headers: {
                        'verifyCode ': '2024'
                    }
                }).then(res => {
                    if(res.data != 'Account is not found or pwd is wrong') {

                        setTimeout(function() {
                            this.fullscreenLoading = false
                            localStorage.setItem('LoginToken', res.data)
                            // this.$router.push('/manager/' + this.LoginForm.account)
                            localStorage.setItem("isManager", 'true')
                            this.$router.push('/manager/' + '互联网社')
                            this.$message({
                                message: '登陆成功',
                                type: 'success'
                            })
