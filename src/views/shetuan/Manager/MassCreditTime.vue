<template>
    <div class="Manager-MassCreditTime">
        <div class="Manager-MassCreditTime_PC">
            ...
            <!-- <div class="Manager-MassBroadCast_rightPost"></div> -->
        </div>
        <!-- <div class="Manager-MassCreditTime_Move">
            <div class="Manager-MassCreditTime_leftTable"></div>
            <div class="Manager-MassCreditTime_rightPost"></div>
        </div> -->
    </div>
</template>
<script>
